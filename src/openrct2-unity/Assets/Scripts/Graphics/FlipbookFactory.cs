namespace Graphics
{
    ...
    public static class FlipbookFactory
    {
        ...
        /// </summary>
        public static Graphic CreateFlipbookGraphic(Graphic[] frames)
        {
            ...
            Graphic output = new Graphic(0, (short)widthFlipbook, (short)heightFlipbook, (short)-distanceLeft, (short)-distanceUpper, outputColors);
        ...
        /// </summary>
        static void CopyColorBlock(Graphic target, int x, int y, Graphic source)
        {
