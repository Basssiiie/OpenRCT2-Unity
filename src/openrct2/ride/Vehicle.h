...
enum : uint32_t
{
    ...
    VEHICLE_UPDATE_FLAG_HAS_COLLIDED = (1 << 6),
...
enum : uint32_t
{
    ...
    VEHICLE_UPDATE_MOTION_TRACK_FLAG_END_OF_TRACK = 1 << 5,
    ...
    VEHICLE_UPDATE_MOTION_TRACK_FLAG_CABLE_LIFT_RETURN_TO_STATION = 1 << 11,
